...
const publicRoutes = ['/login', '/register', '/', '/about', '/contact', '/services', '/privacy']
...
export async function middleware(request: NextRequest) {
  ...
  const isPublicRoute = publicRoutes.some(route => 
    pathname === route || pathname.startsWith('/product') || pathname.startsWith('/categories') || pathname.startsWith('/search')
  )
