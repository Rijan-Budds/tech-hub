    ...
    >
      ...
      >
        ...
        <div className="absolute top-1 left-2">
          <div
            className="w-0.5 h-0.5 bg-white rounded-full animate-ping"
        ...
        <div
          className="absolute top-0.5 left-2.5"
          style={{ animationDelay: "2s" }}
        >
          <div className="animate-pulse">
      ...
      >
        {/* Sun */}
        <div
          className={`absolute transition-all duration-500 ${isDark ? "opacity-0 scale-75" : "opacity-100 scale-100"}`}
        >
          <div className="relative flex items-center justify-center">
            ...
            <div
              className="absolute w-3 h-3 bg-gradient-to-br from-yellow-300 to-yellow-500 rounded-full animate-pulse"
        ...
        {/* Moon */}
        <div
          className={`absolute transition-all duration-500 ${isDark ? "opacity-100 scale-100" : "opacity-0 scale-75"}`}
        >
          <div className="relative flex items-center justify-center">
            {/* Moon glow */}
            <div
              className="absolute w-5 h-5 bg-blue-100 rounded-full opacity-10 animate-pulse"
              style={{ animationDuration: "3s" }}
            ></div>
            <div
              className="absolute w-4 h-4 bg-gray-100 rounded-full opacity-20 animate-ping"
              style={{ animationDuration: "4s" }}
            ></div>
            {/* Moon body */}
            <div
              className="relative w-3 h-3 bg-gradient-to-br from-gray-100 to-gray-300 rounded-full animate-pulse"
