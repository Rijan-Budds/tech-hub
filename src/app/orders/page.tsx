...
export default function OrdersPage() {
  ...
  const { loading, user, orders, loadProfile, refreshOrders } =
    useProfileStore();
                      ...
                      {order.items.map((item, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              className={`w-12 h-12 bg-gray-200 dark:bg-gray-600 rounded-lg flex items-center justify-center ${hasProductDetails && item.image ? "hidden" : ""}`}
                            >
