        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border-l-4 border-[#0D3B66]">
              <div className="flex items-center justify-between">
                ...
                <div className="w-12 h-12 bg-black-100 dark:bg-red-900 rounded-full flex items-center justify-center">
                  <FaHeart className="text-black dark:text-red-400 text-xl" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border-l-4 border-[#1E5CAF]">
              <div className="flex items-center justify-between">
                ...
                <div className="w-12 h-12 bg-black-100 dark:bg-black rounded-full flex items-center justify-center">
                  <FaShoppingBag className="text-black dark:text-blue-400 text-xl" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border-l-4 border-green-500">
              <div className="flex items-center justify-between">
                ...
                <div className="w-12 h-12 bg-black-100 dark:bg-black rounded-full flex items-center justify-center">
                  <FaDollarSign className="text-black dark:text-green-400 text-xl" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 mb-8">
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-10 h-10 bg-black-100 dark:bg-black rounded-full flex items-center justify-center">
                <FaHeart className="text-black dark:text-red-400" />
              </div>
            ...
            {wishlist.length === 0 ? (
              <div className="text-center py-12">
                <div className="w-16 h-16 bg-black-100 dark:bg-black rounded-full flex items-center justify-center mx-auto mb-4">
                  <FaHeart className="text-black dark:text-red-400 text-2xl" />
                </div>
                ...
                <button
                  onClick={() => router.push("/")}
                  className="bg-gradient-to-r from-black to-black text-white px-6 py-3 rounded-xl font-semibold hover:from-black hover:to-black transition-all duration-200"
                >
                  Browse Products
                </button>
              </div>
                ...
                {wishlist.map(
                  (p: {
                    ...
                    >
                      ...
                      <div className="p-4">
                        <h3 className="font-semibold text-gray-900 dark:text-white mb-2 line-clamp-2 group-hover:text-black transition-colors">
                          {p.name}
                        </h3>
